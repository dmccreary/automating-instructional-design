#!/bin/bash
# Build script for Knowledge Graphs for Intelligent Textbooks paper
...
echo "Building A Graph-Guided Architecture for Automated Intelligent Textbook Generation..."
echo "======================================================="
echo ""
