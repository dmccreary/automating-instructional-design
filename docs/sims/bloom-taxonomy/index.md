...
description: An interactive pyramid visualization of Bloom's Revised Taxonomy showing the six cognitive levels from Remember to Create with detailed hover information.
image: /sims/bloom-taxonomy/bloom-taxonomy.png
og:image: /sims/bloom-taxonomy/bloom-taxonomy.png
twitter:image: /sims/bloom-taxonomy/bloom-taxonomy.png
social:
   cards: false
---
...
[Run the Bloom's Taxonomy MicroSim Fullscreen](./main.html){ .md-button .md-button--primary }
[Edit the Bloom's Taxonomy MicroSim Using the p5.js Editor](https://editor.p5js.org/dmccreary/sketches/5gSdPYOWA)
...
```html
<iframe src="https://dmccreary.github.io/automating-instructional-design/sims/bloom-taxonomy/main.html" height="452px" scrolling="no"></iframe>
```
...
2. **Discussion (10 minutes)**: As a class, discuss:
   - Why are the levels arranged in a pyramid?
   - What makes "Create" more complex than "Remember"?
   - How do the levels build upon each other?

3. **Application (15 minutes)**: Give students a topic from their curriculum and have them write one learning objective for each level of the taxonomy.

4. **Analysis (10 minutes)**: Have students exchange objectives with a partner and identify which level each objective represents using the action verbs from the MicroSim.
